...
//         }
        ...
        stage('Analize SonarQube') {
            steps {
                ...
                sh "mvn clean verify sonar:sonar -Dsonar.projectKey=employee-mock-docker -Dsonar.host.url=http://sonarqube -Dsonar.login=d3fdc4c23dec2dec8caf4137e3cfe3f03f8d7429"
            }
        }
